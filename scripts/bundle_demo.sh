...
mkdir -p dist
trunk build --release --public-url "./" --dist "dist" --filehash false "examples/$MAPROX_DEMO/index.html"
trunk build --release --public-url "./" --dist "dist/$MAPROX_APPLICATION" --filehash false "crates/$MAPROX_APPLICATION/index.html"
